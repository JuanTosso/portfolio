  ...
  return (
    <div id="about" className="container about-container">
      <div>
        ...
        <p>
          Hello! 👋🏻 I'm Juan. My background includes accounting and economics,
          with a diverse career spanning finance, auditing, and technology. I've
          held roles from junior to senior and even led my own business,
          developing teamwork skills and a keen understanding of real-world
        ...
        <p>
          ...
          search of a motivated, results-driven learner, I'd love to connect.
        </p>
      </div>
    </div>
  );
